...
Function Connection-Module
{
 ...
 Connect-M365Services -Services "PnP" -SiteUrl $Url -TenantId $TenantId -ClientId $ClientId -CertificateThumbprint $CertificateThumbprint -UserName $UserName -Password $Password
}
